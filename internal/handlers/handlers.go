...
// Neue Helfer-Funktion, um Events zu filtern und zu bereinigen
func filterAndSanitizeEvents(events []*database.Event) []*database.Event {
	...
	for _, e := range events {
		...
		if strings.Contains(desc, "🌍") ||
			...
			desc += "\n\nOrt der Veranstaltung teilen wir dir gerne auf Anfrage via Mail, Social-Media oder Telefon mit."
...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	...
	events = filterAndSanitizeEvents(events)
